...
class Generator:
    ...
    def generate(self, out_folder, split_name, frames_per_room=100):
        ...
        for scene in self._scenes:
            ...
            scene_semantic_dict = self.load_scene_semantic_dict(scene)  # scene: apartment0, apartment1...
...
def main():
    ...
    parser.add_argument("--dataset_folder", type=str, help="Folder containing Replica dataset", default="./dataset/apartment_0/")
    parser.add_argument("--output", type=str, help="Output folder", default="./generate/test/")
